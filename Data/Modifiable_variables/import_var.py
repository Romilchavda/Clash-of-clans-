...
votes_file = open(Utils["secure_folder_path"] + "votes.json", "r")
...
support_file = open(Utils["secure_folder_path"] + "support_for_tickets.json", "r")
...
linked_accounts_file = open(Utils["secure_folder_path"] + "linked_accounts.json", "r")
