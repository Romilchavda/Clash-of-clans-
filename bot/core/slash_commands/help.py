...
async def help(interaction: discord.Interaction):
    embed = create_embed("Help: Slash commands list", "", interaction.guild.me.color, "", interaction.guild.me.avatar.url)
    ...
    embed.add_field(name="Links:", value=f"[{Emojis['Clash_info']} Add the bot](https://rreemmii-dev.github.io/invite) | [{Emojis['Discord']} Support server](https://discord.gg/KQmstPw) | [{Emojis['Github']} GitHub](https://github.com/rreemmii-dev/Clash-Of-Clans-Discord-Bot)", inline=False)
